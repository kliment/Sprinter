...
// In case you have a custom pinage in your electronics, you
// can use a custom pin file here, keeping this main pin.h
// file intact, making it MUCH easier to update.
// We also keep the original values untouch, as a quick reference. 
// To use your own custom pinage, uncomment the line below, modifying
// "customPinFile.h" with your own pinage file name. 
// To create your own custom one, just copy/paste one of the 
// BOARDs setup below into your new file.
//#include "customPinFile.h"
